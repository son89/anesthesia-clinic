	...
	<body class="background">
			...
			<nav class="navbar navbar-default">
				<div class="container-fluid">
					<div class="navbar-header pull-right">
						...
						<a class="navbar-brand font_nazanin" href="#">مشاهده یا ویرایش پرسشنامه قبل از عمل</a>
					</div>
		...
		<div class="container">
			<form id="patient_form_ppo" class="form-horizontal font_nazanin h3" method="post" action="" runat="server">
				<legend><h2>مشخصات شناسنامه ای</h2></legend>

				<div class="form-group">
					<label class="col-md-2 control-label pull-right">نام</label>
					<span class="col-md-4 pull-right">
						<asp:TextBox id="name" CssClass="form-control lightblue_input" ReadOnly="true" runat="server"/>
					</span>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 pull-right">
						<asp:TextBox id="last_name" CssClass="form-control lightblue_input" ReadOnly="true" runat="server"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 pull-right">
						<asp:TextBox id="personl_id" CssClass="form-control lightblue_input" ReadOnly="true" runat="server"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 pull-right">
						<asp:DropDownList id="sex" CssClass="form-control lightblue_input" disabled="disabled" runat="server">
				...
				<div class="form-group">
					...
					<div class="col-md-4 pull-right">
						<asp:TextBox id="age" CssClass="form-control lightblue_input"  placeholder="سن بیمار" ReadOnly="true" runat="server"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 pull-right">
						<asp:TextBox id="height" CssClass="form-control lightblue_input" placeholder="قد بیمار" ReadOnly="true" runat="server"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 pull-right">
						<asp:TextBox id="weigth" CssClass="form-control lightblue_input" placeholder="وزن بیمار" ReadOnly="true" runat="server"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 pull-right">
						<asp:TextBox id="mobile_phone_number" CssClass="form-control lightblue_input" placeholder="شماره مبایل" ReadOnly="true" runat="server"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 pull-right">
						<asp:TextBox id="email" CssClass="form-control lightblue_input" placeholder="ایمیل" ReadOnly="true" runat="server"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4 pull-right">
						<asp:DropDownList id="cat_operation_list" CssClass="form-control lightblue_input" disabled="disabled" runat="server">
				...
				<div class="form-group">
					...
					<div class="col-md-4 pull-right">
						<asp:DropDownList id="operation" CssClass="form-control lightblue_input" disabled="disabled" runat="server">
				...
				<div class="form-group">
					...
					<div class="col-md-4 pull-right">
						<asp:DropDownList id="surgeon_name" CssClass="form-control lightblue_input" disabled="disabeld" runat="server">
							<asp:ListItem Text="خالی"></asp:ListItem>
				...
				<div class="form-group">
					<div class="col-md-6 pull-right">
						<asp:Button Text="اعمال ویرایش یا تایید" UseSubmitBehavior="true" CssClass="btn btn-success btn-lg col-md-12 pull-right" runat="server" id="submit"></asp:Button>
					</div>
				</div>
